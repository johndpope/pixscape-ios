...
class PAPermissionsView: UIView, UITableViewDataSource, UITableViewDelegate {
    ...
    func layoutFrames() {
        self.titleLabel.anchorToEdge(.top, padding: 20, width: 150, height: 50)
    }
	...
	fileprivate func setupUI() {
		...
		let verticalConstraints = NSLayoutConstraint.constraints(
			withVisualFormat: "V:|-98-[detailsLabel(22)]-15-[tableView]-10-[continueButton(30)]-20-|",
			options: [],
			metrics: nil,
			views: views)
	...
	fileprivate func setupDetailsLabel() {
		...
		self.detailsLabel.font = UIFont(name: "AvenirNext-DemiBold", size: 17)
