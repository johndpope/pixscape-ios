...
@objc open class RecordButton : UIButton {
    ...
    open var buttonColor: UIColor! = UIColor.primary {
        didSet {
            circleLayer.backgroundColor = buttonColor.cgColor
            circleBorder.borderColor = UIColor.secondary.cgColor
        }
    }
    open var progressColor: UIColor!  = UIColor.secondary {
        didSet {
    ...
    fileprivate func drawButton() {
        ...
        circleBorder.masksToBounds = false
        circleBorder.shadowRadius = 2.0
        circleBorder.shadowOpacity = 0.2
        circleBorder.shadowOffset = CGSize(width: 1, height: 2)
